...
[![AAAI Accepted](https://img.shields.io/badge/AAAI-Lab%20Accepted-blue)](https://aaai.org/conference/aaai/aaai-26/tutorial-and-lab-list/#lq01)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/)
[![Ollama](https://img.shields.io/badge/Served%20with-Ollama-white)](https://ollama.com/)

**Official website for the AAAI Lab: "SOFAI-LM: A Cognitive Architecture for Building Efficient and Reliable Reasoning Systems with LLMs".**
...
This repository hosts the **Lab Website**. The notebooks and lab code are available at https://github.com/SOFAI-LM-AAAILab/SOFAI-LM.
...
### 2. Notebooks and Code

Use the notebooks and lab code from https://github.com/SOFAI-LM-AAAILab/SOFAI-LM.

## Lab Schedule (Quarter Day)

Presenters: Francesca Rossi and Keerthiram Murugesan.
